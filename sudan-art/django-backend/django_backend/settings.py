...
MEDIA_URL = 'https://{}/{}/'.format(AWS_S3_ENDPOINT_URL, PUBLIC_MEDIA_LOCATION)
DEFAULT_FILE_STORAGE = 'djang_backend.media_stroage.PublicMediaStorage'
REST_FRAMEWORK = {
...
LOGGING = json.loads(os.getenv('DJANGO_LOGGING'))
